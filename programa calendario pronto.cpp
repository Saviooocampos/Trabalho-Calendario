...
void main_menu (int &escolha){    
    ...
    cout << "1.) MENSAL " << endl;
    cout << "2.) ANUAL " << endl;
    cout << "3.) FIM " << endl << endl;
    cout << "Como deseja visualizar ?  ";
    cin >> escolha;
...
void GerarHtml_ano (int ano){
    ...
    cout << " CALENDARIO DE " << ano;
    cout << endl << endl;
    
    ofstream fout;

    fout.open ("calendario2.html");
    if (!fout){
    ...
    for (int m = 1; m <=12; m++){
        ...
        diaSemana(1,m,ano,ds);
        int dia_mes = diasNoMes(m,ano);
        ...
        fout << "<center><h1 aling = \"center\"; style = \"font-size: 120%; color: red;\";  >" ;
    
	    fout << " CALENDARIO DO MES  " << m <<  " DE " << ano << endl;
...
void Gerar_Html (int mes, int ano){
    ...
    fout << "<center><h1 style = \"font-size: 135%; color: red;\">" ;
    
	fout << " CALENDARIO DO MES  " << mes << " DE " << ano << endl;
